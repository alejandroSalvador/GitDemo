...
public class ProductCatalogue extends AbastractComponents {
    ...
    public List<WebElement> getProductList(){
        waitForToAppear(productsBy);
        return productos;
    }

    public WebElement getProductByName(String productName){
        WebElement pro = getProductList().stream().filter(p->
